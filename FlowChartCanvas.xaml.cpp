//
// FlowChartCanvas.xaml.cpp
// FlowChartCanvas 클래스의 구현입니다.
//
...
void SBPMSearchTest03::FlowChartCanvas::FlowchartCanvasInit(int width, int height, int rowNum, int columnNum) {
	nowRowNum = rowNum;
	nowColNum = columnNum;
...
void SBPMSearchTest03::FlowChartCanvas::rowAppend() {
	auto rowDef = ref new RowDefinition;
...
void SBPMSearchTest03::FlowChartCanvas::columnAppend() {
	auto colDef = ref new ColumnDefinition;
...
void SBPMSearchTest03::FlowChartCanvas::flowchartCanvas_SizeChanged(Platform::Object^ sender, Windows::UI::Xaml::SizeChangedEventArgs^ e)
{
